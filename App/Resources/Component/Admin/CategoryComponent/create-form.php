...
<div class="w-full p-5 h-45 shadow-lg">
   <h2 class="mb-1 text-lg font-semibold">Create Category</h2>
   <div class="h-0.5 mb-5 bg-gray-300"></div>
   <form class="" action="<?= $this->request($this->view) ?>" method="post" enctype="multipart/form-data">
      <input class="block" type="hidden" name="action" value="addCategory">

      <div class="mb-3">    
         <label for="category">Category</label>  
         <input class="border" type="text" name="category" placeholder="Category">
      </div>
