<?php
   ...
   $payment   = Transaction::readAllByStatus("payment"); 
   $awaiting  = Transaction::readAllByStatus("awaiting"); 
   $processed = Transaction::readAllByStatus("processed"); 
   $shipping  = Transaction::readAllByStatus("shipping"); 
   $delivered = Transaction::readAllByStatus("delivered"); 
?>

<nav class="col-span-2 w-full">
   <div class="grid grid-rows-5 gap-y-5 text-gray-400">
