<?php
   ...
   $address = Address::readByAddressId($this->id); 
?>
   ...
   <form action="<?= $this->request($this->view) ?>" method="post">
      ...
      <div class="table mb-3">
         ...
         <div class="table-row">
            ...
            <input class="table-cell border" type="text" name="address" value="<?= $address['address'] ?>" placeholder="" required>
         </div>

         <div class="table-row">
            <label class="table-cell " for="receiver">receiver</label>
            <input class="table-cell border" type="text" name="receiver" value="<?= $address['receiver'] ?>" placeholder="" required>
         </div>
      </div>
