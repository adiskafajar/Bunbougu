...
<main>
   <!-- header content -->
   <section class="flex xl:container mx-auto px-5 xl:px-40 h-70 xl:h-120">
      <div class="flex-1">
   ...
   <!-- hot product -->
   <section class="xl:container mx-auto px-5 xl:px-40 mt-12">
      <div class="flex">
   ...
   <!-- category list -->
   <section class="xl:container mx-auto xl:px-40 mt-20 text-center">
      <div class="flex">
      ...
      <div class="grid grid-cols-5 mt-7 text-center">
         <?php foreach ( Category::readForHome() as $category ) : ?>            
            <a href="<?= View::request("product|catalog|{$category['category']}") ?>" class="rounded">
      ...
      <a href="<?= View::request("product|category") ?>" class="inline-block mt-7 py-1 px-7 bg-gray-700 hover:bg-black rounded-2xl text-white">See More</a>
   </section>
   
   <!-- brand list -->
   <section class="xl:container mx-auto xl:px-40 mt-12 text-center">
      <div class="flex">
      ...
      <div class="grid grid-cols-5 mt-7 text-center">
         <?php foreach ( Brand::readForHome() as $brand ) : ?>            
            <a href="<?= View::request("product|catalog|{$brand['brand']}") ?>" class="rounded">
      ...
      <a href="<?= View::request("product|brand") ?>" class="inline-block mt-7 py-1 px-7 bg-gray-700 hover:bg-black rounded-2xl text-white">See More</a>
   </section>
   
   <!-- our store -->
   <section class="container mx-auto px-5 xl:px-40 mt-12 text-center">
      <div class="flex">
